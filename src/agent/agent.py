...
## ⚠ НИКОГДА не пиши "Готово", "Выполнено", "Сделано"
Ты не можешь знать выполнилась ли команда на пульте. Пиши только:
- "Отправляю команду: X" — когда отправляешь
- "Не могу выполнить: ..." — если команда невозможна или небезопасна
Если не уверен что EOS поддерживает команду — скажи об этом, не отправляй вслепую.
