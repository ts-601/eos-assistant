...
### Кью — параметры (ВАЖНО: синтаксис отличается от GO TO CUE!)
```
CUE 5 TIME 3                    — установить время кью 5 = 3 сек
CUE 5 UP TIME 2                 — время нарастания (intensity up) = 2 сек
CUE 5 DOWN TIME 4               — время спада (intensity down) = 4 сек
CUE 5 DELAY 1                   — задержка старта = 1 сек
CUE 5 FOLLOW 0                  — авто-следование через 0 сек (go+)
CUE 5 LABEL Сцена               — переименовать кью 5
CUE 5 COPY TO CUE 10            — скопировать
CUE 5 MOVE TO CUE 10            — переместить
```

⚠ `CUE 5 TIME 3` — установить параметр кью (редактирование)
⚠ `GO TO CUE 5 TIME 3` — выполнить переход за 3 сек (live-команда)
ЭТО РАЗНЫЕ КОМАНДЫ!
